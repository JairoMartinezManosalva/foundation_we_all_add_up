...
export class ContainerMiddleComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.arrUrlIMG = ["apreton-manos-senal-saludo.jpg", "comunidad-diversa-manos-circulo.jpg", "apreton-manos-senal-saludo.jpg", "comunidad-diversa-manos-circulo.jpg"]
  ...
  ngAfterViewInit(): void {
    ...
    for (let i = 0; i < this.totImg; i++) {
      ...
      this.renderer.setAttribute(imgNew, 'src', `./assets/image/${this.arrUrlIMG[i]}`);
